uv run compare_model_formats.py --exp=syn1 --method=wrapped >  syn1err.txt
uv run compare_model_formats.py --exp=syn1 --method=gcn     >> syn1err.txt
uv run compare_model_formats.py --exp=syn1 --method=gcnmm     >> syn1err.txt
