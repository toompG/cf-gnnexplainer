uv run cmp_original.py --exp='syn1' --dst='syn1original' > /dev/null
uv run cmp_original.py --exp='syn4' --dst='syn4original' --lr=.5 > /dev/null
uv run cmp_original.py --exp='syn5' --dst='syn5original' --lr=.5 > /dev/null
